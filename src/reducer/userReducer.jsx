...
export const logUser = createAsyncThunk('userLogin',async (userInfo)=>{
    const response = await axios.post('https://chatapp-backend-5rx4.onrender.com/api/user/login',userInfo)
    return response.data
})

export const signUser = createAsyncThunk('userSignUP', async(userInfo)=>{
    const response = await axios.post('https://chatapp-backend-5rx4.onrender.com/api/user/register',userInfo)
    return response.data
})
